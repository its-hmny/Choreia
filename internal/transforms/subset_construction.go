...
// An adapted version of the classic Subset Construction Algorithm to transform a NFA to an equivalent DFA
...
// Given a set of states calculates the aggregate epsilon closure of said states and returns it
